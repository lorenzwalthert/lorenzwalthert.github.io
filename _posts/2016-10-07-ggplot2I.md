...
(the function that *calls* `current_class`) is `lapply`. For a given iteration, 
...
![plot of chunk unnamed-chunk-11](/figure/source/2016-10-07-ggplot2I/unnamed-chunk-11-1.png)
...
principles developed there can be generalized well to other customization
needs.
